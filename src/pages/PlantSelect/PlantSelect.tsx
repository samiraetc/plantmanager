...
import { EnvironmentButton } from '../../components/EnviromentButton/EnviromentButton';
import { Header } from '../../components/Header/Header';
import { PlantCardPrimary } from '../../components/PlantCardPrimary/PlantCardPrimary';
import api from '../../services/api';
import { Load } from '../../components/Load/Load'
import { useNavigation, useRoute } from '@react-navigation/core';
import { EnviromentProps, PlantProps } from '../../libs/storage';

export function PlantSelect() {
    const navigation = useNavigation();
    const route = useRoute();
    const [environments, setEnvironment] = useState<EnviromentProps[]>([]);
    ...
    const handleEnrivomentSelected = (environment: string) => {
